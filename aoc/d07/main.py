...
def parse_1(input_file):
    '''parse in the file and return a mapping with all the stuff'''
    mapping = {}
...
def parse_2(input_file):
    '''parse to find real children of shiny gold bag...
    but need to record the #'''
    mapping = {}
    for line in input_file.readlines():
        phrase = parse_line(line)
        parent_color, children = words_to_node_2(phrase)
